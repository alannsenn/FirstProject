<section style="height: auto; width: auto; box-sizing: border-box; background-color: #212529;" id="" class="">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="">
          <div class="list-space-footer-2-3">
              <a href="index.html" class="text-white fs-3 text-uppercase fw-bold text-decoration-none"> Tutor.In </a>
          </div>
        <nav style="list-style-type:none;">
          <li class="list-space-footer-2-3">
            <a class="list-menu-footer-2-3" href="index.html">Home</a>
          </li>
          <li class="list-space-footer-2-3">
            <a class="list-menu-footer-2-3">About</a>
          </li>
          <li class="list-space-footer-2-3">
            <a class="list-menu-footer-2-3">Pricing</a>
          </li>
        </nav>
      </div>
      </div>
    ...
    <div class="">              
      ...
      <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space-footer-2-3">
          ...
          <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
              <p style="margin: 0">Copyright ©  2021 Alan Sen</p>
            </nav>
        </div>
      </div>
    </div>
